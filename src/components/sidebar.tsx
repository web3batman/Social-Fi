  ...
  return (
    <div className='lg:shrink-0 max-md:hidden'>
      <div className='flex flex-col gap-2 rounded-[15px] bg-white dark:bg-dark-header-bg w-[200px] lg:w-[250px] p-2'>
        <Link href={'/home'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/home' ? styles.active : 'text-grey-1'}`}>
        ...
        <Link href={'/search'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/search' ? styles.active : 'text-grey-1'}`}>
          <div className='flex gap-3 items-center'>
        ...
        <Link href={'/keys'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/keys' ? styles.active : 'text-grey-1'}`}>
          <div className='flex gap-3 items-center'>
        ...
        <Link href={'/notifications'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/notifications' ? styles.active : 'text-grey-1'}`}>
          <div className='flex gap-3 items-center'>
        ...
        <Link href={'/inbox'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/inbox' ? styles.active : 'text-grey-1'}`}>
          <div className='flex gap-3 items-center'>
        ...
        <Link href={'/wallet'} className={`p-4 cursor-pointer hover:bg-gray-300 dark:bg-dark-body-bg rounded-lg ${currentPage == '/wallet' ? styles.active : 'text-grey-1'}`}>
          <div className='flex gap-3 items-center'>
